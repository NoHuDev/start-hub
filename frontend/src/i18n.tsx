...
const translations: Record<LanguageCode, Translations> = {
  en: {
    ...
    customIconPlaceholder: 'Custom Icon Image (Absolute path to .png / .jpg)',
    ...
    fontTextLabel: 'Text Font',
    previewLabel: 'Preview',
    previewHeading: 'Franz jagt im komplett verwahrlosten Taxi quer durch Bayern',
    previewParagraph: 'Start Hub is a modern dashboard that serves as your central start page and project center. You can manage your projects, run developer scripts, and monitor system metrics.',
    cancel: 'Cancel',
    save: 'Save',
    ...
    secondaryIde: 'Secondary IDE',
    noPrimaryIde: 'No primary IDE',
    noSecondaryIde: 'No secondary IDE',
    startConfigTitle: 'Start Configuration',
    ...
    extraButtonsTitle: 'Additional Buttons',
  ...
  de: {
    ...
    customIconPlaceholder: 'Eigenes Icon Bild (Absoluter Pfad zu .png / .jpg)',
    languageLabel: 'System-Sprache',
    languageHelp: 'Wähle die Sprache der Benutzeroberfläche.',
    tabGeneral: 'Allgemein',
    tabIdes: 'IDEs',
    tabAppearance: 'Darstellung',
    fontTitleLabel: 'Schriftart für Titel',
    fontTextLabel: 'Schriftart für Text',
    previewLabel: 'Vorschau',
    previewHeading: 'Franz jagt im komplett verwahrlosten Taxi quer durch Bayern',
    previewParagraph: 'Start Hub ist ein modernes Dashboard, das als Ihre zentrale Startseite und Projektzentrale dient. Verwalten Sie Ihre Projekte, führen Sie Entwickler-Skripte aus und überwachen Sie Systemmetriken.',
    cancel: 'Abbrechen',
    save: 'Speichern',
    ...
    extraButtonsTitle: 'Zusätzliche Buttons',
  ...
  es: {
    ...
    customIconPlaceholder: 'Imagen de icono personalizada (Ruta absoluta a .png / .jpg)',
    ...
    extraButtonsTitle: 'Botones adicionales',
  ...
  fr: {
    ...
    customIconPlaceholder: 'Image d\'icône personnalisée (Chemin absolu vers .png / .jpg)',
    ...
    extraButtonsTitle: 'Boutons supplémentaires',
